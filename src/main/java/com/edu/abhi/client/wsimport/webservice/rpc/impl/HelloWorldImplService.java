...
package com.edu.abhi.client.wsimport.webservice.rpc.impl;
 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://impl.rpc.webservice.abhi.edu.com/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://impl.rpc.webservice.abhi.edu.com/", "HelloWorldImplService");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://impl.rpc.webservice.abhi.edu.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.rpc.webservice.abhi.edu.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
